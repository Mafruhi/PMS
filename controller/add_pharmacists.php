...
$fname = $lname =$gender = $dob= $religion = $praddress = $pmaddress = $phone = $email = $website = $username = $password = "";
...
if($password == "")
{
  ...
  if ($isValidate) {
    ...
    header("location: ../view/pharmacists_dashboard.php"); 
    $sql = "INSERT INTO add_pharmacists VALUES ('$fname', '$lname', '$gender', '$dob', '$religion', '$praddress', '$pmaddress', '$phone', '$email', '$website', '$username', '$password');";
