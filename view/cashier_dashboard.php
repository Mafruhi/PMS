...
?>
    ...
    <form action="../view/add_cashier.html"><input type="submit" value="Add Cashier"></form>
    <br>
    <form action="..//controller/delete_cashier.php"><input type="submit" value="Delete Cashier"></form>
    <br>
    <br>
