...
<body>
    ...
    <legend class = "top" >Managers : </legend>
    <hr>
    <br>
<?php
...
?>
    ...
    <form action="../controller/add_manager.html"><input type="submit" value="Add Manager"></form>
    <br>
    <form action="..//controller/delete_manager.php"><input type="submit" value="Delete Manager"></form>
    <br>
    <br>
